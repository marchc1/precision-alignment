...
surface.CreateFont("PAToolScreen_Title", {
	font = "HUDNumber",
	size = 60,
	weight = 400,
	antialias = true,
...
surface.CreateFont("PAToolScreen_ToolType", {
	font = "TabLarge",
	size = 70,
	weight = 400,
	antialias = true,
...
surface.CreateFont("PAToolScreen_ToolDesc", {
	font = "TabLarge",
	size = 29,
	weight = 400,
	antialias = true,
...
local function DrawIndicators(x, y, w)
	...
	for i = 1, 9 do
		...
		if i == ConstructNum then draw.RoundedBox(radius + 4, xpos - 4, ypos - 4, diameter + 8, diameter + 8, Color(255, 255, 255, 255)) end
